...
class __TwigTemplate_a78dcee77a4e44dbc2ad8e665de4af54 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("%sCreate%s a database named '%s' and setup the phpMyAdmin configuration storage there.");
                    ...
                    // line 19
                    echo call_user_func_array($this->env->getFilter('notice')->getCallable(), [twig_sprintf($___internal_parse_0_, (((("<a href=\"" . PhpMyAdmin\Url::getFromRoute("/check-relations")) . "\" data-post=\"") . PhpMyAdmin\Url::getCommon(["db" => ($context["db"] ?? null), "create_pmadb" => true, "goto" => PhpMyAdmin\Url::getFromRoute("/database/operations")])) . "\">"), "</a>", ($context["config_storage_database_name"] ?? null))]);
                    // line 22
                    echo "      ";
                } else {
                    // line 23
...
echo _gettext("%sCreate%s the phpMyAdmin configuration storage in the current database.");
                    ...
                    // line 23
                    echo call_user_func_array($this->env->getFilter('notice')->getCallable(), [twig_sprintf($___internal_parse_1_, (((("<a href=\"" . PhpMyAdmin\Url::getFromRoute("/check-relations")) . "\" data-post=\"") . PhpMyAdmin\Url::getCommon(["db" => ($context["db"] ?? null), "fixall_pmadb" => true, "goto" => PhpMyAdmin\Url::getFromRoute("/database/operations")])) . "\">"), "</a>")]);
                    // line 26
                    echo "      ";
                }
                // line 27
...
echo _gettext("%sCreate%s missing phpMyAdmin configuration storage tables.");
                ...
                // line 30
                echo call_user_func_array($this->env->getFilter('notice')->getCallable(), [twig_sprintf($___internal_parse_2_, (((("<a href=\"" . PhpMyAdmin\Url::getFromRoute("/check-relations")) . "\" data-post=\"") . PhpMyAdmin\Url::getCommon(["db" => ($context["db"] ?? null), "fix_pmadb" => true, "goto" => PhpMyAdmin\Url::getFromRoute("/database/operations")])) . "\">"), "</a>")]);
                // line 33
                echo "    ";
            }
            // line 34
...
";
    ...
    {
        return new Source("", "relation/check_relations.twig", "/Users/mmsit/Desktop/WAD/phpMyAdmin-5.2.0-all-languages/templates/relation/check_relations.twig");
    }
}
